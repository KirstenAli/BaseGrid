...
BaseGrid is a polished proof-of-concept portal for a four-tenant, single-node OpenStack cloud. It includes a public product site, quota-aware registration, a tenant control centre, package changes, a mock Horizon login and a persistent D1 account ledger.

## Capacity model

The physical host provides 32 GB RAM, 2 TB storage and 64 hardware threads. BaseGrid reserves 8 GB RAM, 500 GB storage and 16 threads for the host and OpenStack services. The remaining 24 GB, 1.5 TB and 48 threads are divided across four compatible packages; even four Pro packages fit the allocatable envelope.
